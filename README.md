...
This project provides a machine learning-based solution to detect and quantify hate speech in textual data using Natural Language Processing (NLP) techniques and sequential model.
...
- Use synthetic and real-world labeled data to train a supervised model using `Sequential Model`.
...
print(f"There is a {round(model.predict(inp)[0, 0], 2)*100}% chance that this sentence contains hate-speech.")
```
